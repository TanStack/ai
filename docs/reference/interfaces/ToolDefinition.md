...
- [`ToolDefinitionInstance`](../ToolDefinitionInstance)\<`TInput`, `TOutput`, `TName`\>
...
[`ToolDefinitionInstance`](../ToolDefinitionInstance).[`__toolSide`](../ToolDefinitionInstance#__toolside)
...
[`ClientTool`](../ClientTool)\<`TInput`, `TOutput`, `TName`\>
...
[`ToolDefinitionInstance`](../ToolDefinitionInstance).[`description`](../ToolDefinitionInstance#description)
...
[`ToolDefinitionInstance`](../ToolDefinitionInstance).[`execute`](../ToolDefinitionInstance#execute)
...
[`ToolDefinitionInstance`](../ToolDefinitionInstance).[`inputSchema`](../ToolDefinitionInstance#inputschema)
...
[`ToolDefinitionInstance`](../ToolDefinitionInstance).[`metadata`](../ToolDefinitionInstance#metadata)
...
[`ToolDefinitionInstance`](../ToolDefinitionInstance).[`name`](../ToolDefinitionInstance#name)
...
[`ToolDefinitionInstance`](../ToolDefinitionInstance).[`needsApproval`](../ToolDefinitionInstance#needsapproval)
...
[`ToolDefinitionInstance`](../ToolDefinitionInstance).[`outputSchema`](../ToolDefinitionInstance#outputschema)
...
[`ServerTool`](../ServerTool)\<`TInput`, `TOutput`, `TName`\>
