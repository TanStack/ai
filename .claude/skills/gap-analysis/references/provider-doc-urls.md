...
If you find a URL has permanently moved while running an audit, update this
file in the same report turn — the maintainer will see the change in
`git status` alongside the new report.
