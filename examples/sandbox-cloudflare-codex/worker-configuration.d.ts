...
interface __BaseEnv_Env {
  // Provide EITHER — `codex exec` authenticates with the OpenAI key; the app injects
  // whichever is set into the sandbox as CODEX_API_KEY. (Secrets, set in .dev.vars /
  // `wrangler secret put`; optional here because only one is required.)
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<
    Pick<Cloudflare.Env, 'CODEX_API_KEY' | 'OPENAI_API_KEY'>
  > {}
}
