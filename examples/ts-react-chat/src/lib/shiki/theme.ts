  ...
  tokenColors: [
    {
      ...
      settings: { foreground: '#6a5f53', fontStyle: 'italic' },
    },
    ...
    { scope: ['string.regexp'], settings: { foreground: '#c84b1c' } },
    {
      ...
      settings: { foreground: '#c84b1c' },
    },
    {
      scope: ['constant.character.escape'],
      settings: { foreground: '#d8ad00' },
    },
    {
      scope: ['keyword', 'storage.type', 'storage.modifier'],
      settings: { foreground: '#ffce00' },
    },
    {
    ...
    {
      scope: ['variable.other.object', 'variable.other.property'],
      settings: { foreground: '#e8dfd1' },
    },
    ...
    // `meta.diff.header`.
    {
      scope: ['markup.inserted', 'meta.diff.inserted'],
      settings: { foreground: '#a8b86b' },
    },
    {
      scope: ['markup.deleted', 'meta.diff.deleted'],
      settings: { foreground: '#c84b1c' },
    },
    { scope: ['markup.changed'], settings: { foreground: '#d8ad00' } },
    {
      scope: ['meta.diff.header', 'meta.diff.range'],
      settings: { foreground: '#ffce00', fontStyle: 'italic' },
    },
    ...
    // ── markdown ───────────────────────────────────────────────────────
    {
      ...
      settings: { foreground: '#ffce00', fontStyle: 'bold' },
    },
    { scope: ['markup.italic'], settings: { fontStyle: 'italic' } },
    { scope: ['markup.bold'], settings: { fontStyle: 'bold' } },
    {
      scope: ['markup.fenced_code', 'markup.inline.raw'],
      settings: { foreground: '#a8b86b' },
    },
    {
      scope: ['markup.list.numbered', 'markup.list.unnumbered'],
      settings: { foreground: '#93887a' },
    },
