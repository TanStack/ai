...
describe('makeGroqStructuredOutputCompatible', () => {
  ...
  it('should normalise nested empty-object schemas in properties', () => {
    ...
    // `properties` slipped past the ai-openai-compatible transformer because the
    ...
    // ai-openai-compatible sets additionalProperties: false on every rewritten object
