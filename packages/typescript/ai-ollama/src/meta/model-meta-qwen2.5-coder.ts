...
export type Qwen2_5CoderChatModelProviderOptionsByName = {
  ...
  [QWEN2_5_CODER_LATEST.name]: OllamaModelMeta<
    OllamaChatRequest &
      OllamaChatRequestMessages<OllamaMessageTools> &
      OllamaChatRequestTools
  >
  [QWEN2_5_CODER_0_5b.name]: OllamaModelMeta<
    OllamaChatRequest &
      OllamaChatRequestMessages<OllamaMessageTools> &
      OllamaChatRequestTools
  >
  [QWEN2_5_CODER_1_5b.name]: OllamaModelMeta<
    OllamaChatRequest &
      OllamaChatRequestMessages<OllamaMessageTools> &
      OllamaChatRequestTools
  >
  [QWEN2_5_CODER_3b.name]: OllamaModelMeta<
    OllamaChatRequest &
      OllamaChatRequestMessages<OllamaMessageTools> &
      OllamaChatRequestTools
  >
  [QWEN2_5_CODER_7b.name]: OllamaModelMeta<
    OllamaChatRequest &
      OllamaChatRequestMessages<OllamaMessageTools> &
      OllamaChatRequestTools
  >
  [QWEN2_5_CODER_14b.name]: OllamaModelMeta<
    OllamaChatRequest &
      OllamaChatRequestMessages<OllamaMessageTools> &
      OllamaChatRequestTools
  >
  [QWEN2_5_CODER_32b.name]: OllamaModelMeta<
    OllamaChatRequest &
      OllamaChatRequestMessages<OllamaMessageTools> &
      OllamaChatRequestTools
  >
