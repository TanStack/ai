...
export type Qwen2_5CoderChatModelProviderOptionsByName = {
  ...
  [QWEN2_5_CODER_LATEST.name]: ChatRequest
  [QWEN2_5_CODER_0_5b.name]: ChatRequest
  [QWEN2_5_CODER_1_5b.name]: ChatRequest
  [QWEN2_5_CODER_3b.name]: ChatRequest
  [QWEN2_5_CODER_7b.name]: ChatRequest
  [QWEN2_5_CODER_14b.name]: ChatRequest
  [QWEN2_5_CODER_32b.name]: ChatRequest
}
