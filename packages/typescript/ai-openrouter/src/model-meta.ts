...
const QWEN_QWEN3_5_27B =  {
    ...
    supports: {
      input: ['text', 'image', 'video'],
      output: ['text'],
      supports: ['frequency_penalty', 'include_reasoning', 'logprobs', 'max_tokens', 'presence_penalty', 'reasoning', 'repetition_penalty', 'response_format', 'seed', 'stop', 'structured_outputs', 'temperature', 'tool_choice', 'tools', 'top_k', 'top_logprobs', 'top_p'],
    },
    context_window: 262144,
    max_output_tokens: 65536,
    pricing: {
...
const THEDRUMMER_UNSLOPNEMO_12B =  {
    ...
    supports: {
      input: ['text'],
      output: ['text'],
      supports: ['frequency_penalty', 'logprobs', 'max_tokens', 'presence_penalty', 'response_format', 'stop', 'structured_outputs', 'temperature', 'tool_choice', 'tools', 'top_logprobs', 'top_p'],
    },
    context_window: 32768,
    max_output_tokens: 32768,
    pricing: {
...
export type OpenRouterModelOptionsByName  = {
  [BYTEDANCE_SEED_SEED_2_0_MINI.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'include_reasoning' | 'max_completion_tokens' | 'reasoning' | 'response_format' | 'stop' | 'temperature' | 'tool_choice' | 'top_p'>;
  [GOOGLE_GEMINI_3_1_FLASH_IMAGE_PREVIEW.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'include_reasoning' | 'max_completion_tokens' | 'reasoning' | 'response_format' | 'seed' | 'stop' | 'temperature' | 'top_p'>;
  [QWEN_QWEN3_5_35B_A3B.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'include_reasoning' | 'logit_bias' | 'logprobs' | 'max_completion_tokens' | 'presence_penalty' | 'reasoning' | 'repetition_penalty' | 'response_format' | 'seed' | 'stop' | 'temperature' | 'tool_choice' | 'top_k' | 'top_logprobs' | 'top_p'>;
  [QWEN_QWEN3_5_27B.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'include_reasoning' | 'logprobs' | 'max_completion_tokens' | 'presence_penalty' | 'reasoning' | 'repetition_penalty' | 'response_format' | 'seed' | 'stop' | 'temperature' | 'tool_choice' | 'top_k' | 'top_logprobs' | 'top_p'>;
  [QWEN_QWEN3_5_122B_A10B.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'include_reasoning' | 'logprobs' | 'max_completion_tokens' | 'presence_penalty' | 'reasoning' | 'repetition_penalty' | 'response_format' | 'seed' | 'stop' | 'temperature' | 'tool_choice' | 'top_k' | 'top_logprobs' | 'top_p'>;
  [QWEN_QWEN3_5_FLASH_02_23.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'include_reasoning' | 'max_completion_tokens' | 'presence_penalty' | 'reasoning' | 'response_format' | 'seed' | 'temperature' | 'tool_choice' | 'top_p'>;
  [LIQUID_LFM_2_24B_A2B.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'logit_bias' | 'max_completion_tokens' | 'min_p' | 'presence_penalty' | 'repetition_penalty' | 'stop' | 'temperature' | 'top_k' | 'top_p'>;
  [GOOGLE_GEMINI_3_1_PRO_PREVIEW_CUSTOMTOOLS.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'include_reasoning' | 'max_completion_tokens' | 'reasoning' | 'response_format' | 'seed' | 'stop' | 'temperature' | 'tool_choice' | 'top_p'>;
  [OPENAI_GPT_5_3_CODEX.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'include_reasoning' | 'max_completion_tokens' | 'reasoning' | 'response_format' | 'seed' | 'tool_choice'>;
  [AION_LABS_AION_2_0.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'include_reasoning' | 'max_completion_tokens' | 'reasoning' | 'temperature' | 'top_p'>;
  ...
  [UPSTAGE_SOLAR_PRO_3.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'include_reasoning' | 'max_completion_tokens' | 'reasoning' | 'response_format' | 'temperature' | 'tool_choice'>;
  ...
  [ESSENTIALAI_RNJ_1_INSTRUCT.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'logit_bias' | 'max_completion_tokens' | 'min_p' | 'presence_penalty' | 'repetition_penalty' | 'response_format' | 'stop' | 'temperature' | 'tool_choice' | 'top_k' | 'top_p'>;
  ...
  [MISTRALAI_MINISTRAL_14B_2512.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'max_completion_tokens' | 'presence_penalty' | 'response_format' | 'seed' | 'stop' | 'temperature' | 'tool_choice' | 'top_p'>;
  ...
  [KWAIPILOT_KAT_CODER_PRO.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'logit_bias' | 'max_completion_tokens' | 'min_p' | 'presence_penalty' | 'repetition_penalty' | 'response_format' | 'seed' | 'stop' | 'temperature' | 'tool_choice' | 'top_k' | 'top_p'>;
  ...
  [MINIMAX_MINIMAX_M2.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'include_reasoning' | 'logit_bias' | 'max_completion_tokens' | 'min_p' | 'presence_penalty' | 'reasoning' | 'repetition_penalty' | 'response_format' | 'seed' | 'stop' | 'temperature' | 'tool_choice' | 'top_k' | 'top_p'>;
  ...
  [GOOGLE_GEMINI_2_5_FLASH_IMAGE.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'max_completion_tokens' | 'response_format' | 'seed' | 'stop' | 'temperature' | 'top_p'>;
  ...
  [DEEPSEEK_DEEPSEEK_V3_2_EXP.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'include_reasoning' | 'logit_bias' | 'max_completion_tokens' | 'min_p' | 'presence_penalty' | 'reasoning' | 'repetition_penalty' | 'response_format' | 'seed' | 'stop' | 'temperature' | 'tool_choice' | 'top_k' | 'top_p'>;
  ...
  [DEEPSEEK_DEEPSEEK_V3_1_TERMINUS.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'include_reasoning' | 'logit_bias' | 'max_completion_tokens' | 'min_p' | 'presence_penalty' | 'reasoning' | 'repetition_penalty' | 'response_format' | 'seed' | 'stop' | 'temperature' | 'tool_choice' | 'top_k' | 'top_p'>;
  ...
  [ALIBABA_TONGYI_DEEPRESEARCH_30B_A3B.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'include_reasoning' | 'logit_bias' | 'max_completion_tokens' | 'min_p' | 'presence_penalty' | 'reasoning' | 'repetition_penalty' | 'response_format' | 'seed' | 'stop' | 'temperature' | 'tool_choice' | 'top_k' | 'top_p'>;
  ...
  [MEITUAN_LONGCAT_FLASH_CHAT.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'logit_bias' | 'max_completion_tokens' | 'min_p' | 'presence_penalty' | 'repetition_penalty' | 'response_format' | 'seed' | 'stop' | 'temperature' | 'tool_choice' | 'top_k' | 'top_p'>;
  ...
  [QWEN_QWEN3_30B_A3B_THINKING_2507.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'include_reasoning' | 'logit_bias' | 'max_completion_tokens' | 'min_p' | 'presence_penalty' | 'reasoning' | 'repetition_penalty' | 'response_format' | 'seed' | 'stop' | 'temperature' | 'tool_choice' | 'top_k' | 'top_p'>;
  ...
  [QWEN_QWEN3_30B_A3B_INSTRUCT_2507.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'logit_bias' | 'max_completion_tokens' | 'min_p' | 'presence_penalty' | 'repetition_penalty' | 'response_format' | 'seed' | 'stop' | 'temperature' | 'tool_choice' | 'top_k' | 'top_p'>;
  ...
  [QWEN_QWEN3_CODER_EXACTO.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'max_completion_tokens' | 'repetition_penalty' | 'response_format' | 'seed' | 'temperature' | 'tool_choice' | 'top_k' | 'top_p'>;
  ...
  [GOOGLE_GEMMA_3N_E2B_IT_FREE.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'max_completion_tokens' | 'response_format' | 'seed' | 'temperature' | 'top_p'>;
  ...
  [GOOGLE_GEMMA_3N_E4B_IT_FREE.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'max_completion_tokens' | 'response_format' | 'seed' | 'temperature' | 'top_p'>;
  ...
  [QWEN_QWEN3_8B.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'include_reasoning' | 'logit_bias' | 'max_completion_tokens' | 'min_p' | 'presence_penalty' | 'reasoning' | 'repetition_penalty' | 'response_format' | 'seed' | 'stop' | 'temperature' | 'tool_choice' | 'top_k' | 'top_p'>;
  ...
  [QWEN_QWQ_32B.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'include_reasoning' | 'logprobs' | 'max_completion_tokens' | 'presence_penalty' | 'reasoning' | 'response_format' | 'stop' | 'temperature' | 'tool_choice' | 'top_k' | 'top_logprobs' | 'top_p'>;
  ...
  [DEEPSEEK_DEEPSEEK_R1_DISTILL_QWEN_32B.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'include_reasoning' | 'logprobs' | 'max_completion_tokens' | 'presence_penalty' | 'reasoning' | 'repetition_penalty' | 'response_format' | 'seed' | 'stop' | 'temperature' | 'top_k' | 'top_logprobs' | 'top_p'>;
  ...
  [SAO10K_L3_3_EURYALE_70B.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'logprobs' | 'max_completion_tokens' | 'min_p' | 'presence_penalty' | 'repetition_penalty' | 'response_format' | 'seed' | 'stop' | 'temperature' | 'top_k' | 'top_logprobs' | 'top_p'>;
  ...
  [THEDRUMMER_UNSLOPNEMO_12B.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'logprobs' | 'max_completion_tokens' | 'presence_penalty' | 'response_format' | 'stop' | 'temperature' | 'tool_choice' | 'top_logprobs' | 'top_p'>;
  ...
  [QWEN_QWEN_2_5_7B_INSTRUCT.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'logit_bias' | 'max_completion_tokens' | 'min_p' | 'presence_penalty' | 'repetition_penalty' | 'response_format' | 'seed' | 'stop' | 'temperature' | 'tool_choice' | 'top_k' | 'top_p'>;
  ...
  [THEDRUMMER_ROCINANTE_12B.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'logit_bias' | 'logprobs' | 'max_completion_tokens' | 'min_p' | 'presence_penalty' | 'repetition_penalty' | 'response_format' | 'seed' | 'stop' | 'temperature' | 'tool_choice' | 'top_k' | 'top_logprobs' | 'top_p'>;
  ...
  [META_LLAMA_LLAMA_3_2_3B_INSTRUCT.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'logit_bias' | 'max_completion_tokens' | 'min_p' | 'presence_penalty' | 'repetition_penalty' | 'seed' | 'stop' | 'temperature' | 'top_k' | 'top_p'>;
  ...
  [META_LLAMA_LLAMA_3_2_11B_VISION_INSTRUCT.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'max_completion_tokens' | 'min_p' | 'presence_penalty' | 'repetition_penalty' | 'response_format' | 'seed' | 'stop' | 'temperature' | 'top_k' | 'top_p'>;
