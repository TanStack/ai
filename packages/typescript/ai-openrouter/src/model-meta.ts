...
const GOOGLE_GEMINI_2_0_FLASH_LITE_001 = {
  ...
  supports: {
    ...
    output: ['text', 'image', 'document', 'audio', 'video'],
    supports: [
      'max_tokens',
      'response_format',
      'seed',
...
const GOOGLE_GEMINI_2_5_FLASH_PREVIEW_09_2025 = {
  ...
  supports: {
    ...
    output: ['image', 'document', 'text', 'audio', 'video'],
    supports: [
      'include_reasoning',
      'max_tokens',
      'reasoning',
...
const AMAZON_NOVA_2_LITE_V1 = {
  ...
  supports: {
    ...
    output: ['text', 'image', 'video', 'document'],
    supports: [
      'include_reasoning',
      'max_tokens',
      'reasoning',
...
const GOOGLE_GEMINI_2_5_FLASH = {
  ...
  supports: {
    ...
    output: ['document', 'image', 'text', 'audio', 'video'],
    supports: [
      'include_reasoning',
      'max_tokens',
      'reasoning',
...
const GOOGLE_GEMINI_2_5_PRO_PREVIEW = {
  ...
  supports: {
    ...
    output: ['document', 'image', 'text', 'audio'],
    supports: [
      'include_reasoning',
      'max_tokens',
      'reasoning',
