...
export interface TanstackAiSchema {
  ...
  interrupts: AiTable<{
    ...
    runId: AiColumn<string>
    threadId: AiColumn<string>
    generation: AiColumn<number>
    status: AiColumn<InterruptRecord['status']>
    requestedAt: AiColumn<number>
    resolvedAt: AiColumn<number>
    payloadJson: AiColumn<InterruptRecord['payload']>
    bindingJson: AiColumn<InterruptBinding>
    responseSchemaHash: AiColumn<string>
    responseJson: AiColumn<unknown>
  }>
  interruptBatches: AiTable<{
    interruptedRunId: AiColumn<string>
    threadId: AiColumn<string>
    generation: AiColumn<number>
    expectedInterruptIdsJson: AiColumn<
      InterruptBatchRecord['expectedInterruptIds']
    >
    fingerprint: AiColumn<string>
    canonicalResolutions: AiColumn<string>
    resolutionsJson: AiColumn<InterruptBatchRecord['resolutions']>
    continuationRunId: AiColumn<string>
    committedAt: AiColumn<number>
  }>
  metadata: AiTable<{
