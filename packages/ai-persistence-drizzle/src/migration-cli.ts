...
const usage = `Usage: tanstack-ai-drizzle-migrations (--out <directory> | --stdout) [--force]

Options:
  --out <directory>  Copy the ordered SQLite migration files.
...
/** Execute the migration asset CLI. Exported for deterministic CLI tests. */
export async function runDrizzleMigrationsCli(
