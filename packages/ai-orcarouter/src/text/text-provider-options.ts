...
/**
 * OrcaRouter provider options for text/chat models.
 *
 * OrcaRouter exposes the OpenAI Chat Completions wire format and routes
 ...
 */
export interface OrcaRouterTextProviderOptions {
  /**
   ...
   * the model and the provider it is routed to.
   */
  reasoning_effort?:
    | 'none'
    | 'minimal'
 ...
 */
export type ExternalTextProviderOptions = OrcaRouterTextProviderOptions
